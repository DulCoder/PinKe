...
public class Register_Fragment extends Fragment implements View.OnClickListener {
    ...
    public static Register_Fragment newInstance() {
        Register_Fragment mFragment = new Register_Fragment();
        return mFragment;
    }
...
//            int value = (Integer) data.getSerializableExtra(IconDialogFragment.EXTRA_ICON);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.iv_icon:
                ...
                dialogFragment.setTargetFragment(Register_Fragment.this, REQUEST_ICON);   //设置目标Fragment
    ...
    private void goBack() {
        getFragmentManager()
                .beginTransaction()
                .replace(R.id.activity_ring_up_container, Login_Fragment.newInstance())
                .commit();
    }
